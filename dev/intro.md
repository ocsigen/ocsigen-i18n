...
- **Tyxml**: generates HTML elements using [Tyxml](https://github.com/ocsigen/tyxml) (`--tyxml`)
- **Eliom**: generates client-server code for [Eliom](https://ocsigen.org/eliom/) apps (`--eliom`)
